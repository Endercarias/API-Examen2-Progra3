...
import com.examen.api.reposities.ClientRepository;
...
public class ClientController {
	...
	@PutMapping(value = "/{id}")
	@ResponseStatus(code = HttpStatus.ACCEPTED)
	public Cliente updateClient(@PathVariable(name = "id") Long id, @RequestBody Cliente cliente) {
		...
		if (oCliente.isPresent()) {
			...
			Cliente updateClient = repository.save(actual);
			return updateClient;
		}
		return null;
	}
