...
import com.examen.api.reposities.TarifRepository;
...
public class TarifController {
	...
	@PutMapping(value = "/{id}")
	@ResponseStatus(code = HttpStatus.ACCEPTED)
	public Tarifa updateTarif(@PathVariable(name = "id") Long id, @RequestBody Tarifa tarifa) {
			...
			if (oTarifa.isPresent()) {
				...
				Tarifa updateTarif = repository.save(actual);
				return updateTarif;
			}
			return null;
		}
